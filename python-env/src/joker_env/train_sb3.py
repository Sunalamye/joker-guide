...
def main() -> None:
    ...
    parser.add_argument("--n-steps", type=int, default=512, help="v10.1: 512 for longer rollouts (was 256)")
    parser.add_argument("--batch-size", type=int, default=256, help="v10.1: 256 to reduce SGD updates per rollout (was 64)")
    parser.add_argument("--batch-env", action="store_true", help="Use batch Step RPC in a single process VecEnv")
    parser.add_argument("--ent-coef", type=float, default=0.06, help="v10.1: 0.06 initial entropy (was 0.05)")
    parser.add_argument("--learning-rate", type=float, default=3e-4)
    parser.add_argument("--gamma", type=float, default=0.95, help="v10.1: 0.95 for ~200-step episodes (was 0.99, v8_7 used 0.95)")
    parser.add_argument("--gae-lambda", type=float, default=0.92, help="v10.1: 0.92 matched v8_7 breakthrough (was 0.95)")
    parser.add_argument("--clip-range", type=float, default=0.2)
    parser.add_argument("--clip-range-vf", type=float, default=0.2, help="v10.1: 0.2 to prevent value function overfitting (was None)")
    ...
    parser.add_argument("--n-epochs", type=int, default=3, help="v10.1: 3 to reduce overfitting (was 4)")
    parser.add_argument("--vf-coef", type=float, default=0.5)
    parser.add_argument("--max-grad-norm", type=float, default=0.5)
    parser.add_argument("--target-kl", type=float, default=0.02, help="v10.1: 0.02 slightly relaxed (was 0.015)")
