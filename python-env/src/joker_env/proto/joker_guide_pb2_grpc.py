...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in joker_guide_pb2_grpc.py depends on'
...
class JokerEnvStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Reset = channel.unary_unary(
                '/joker_guide.v1.JokerEnv/Reset',
                request_serializer=joker__guide__pb2.ResetRequest.SerializeToString,
                response_deserializer=joker__guide__pb2.ResetResponse.FromString,
...
def add_JokerEnvServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Reset': grpc.unary_unary_rpc_method_handler(
                    servicer.Reset,
                    request_deserializer=joker__guide__pb2.ResetRequest.FromString,
                    response_serializer=joker__guide__pb2.ResetResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'joker_guide.v1.JokerEnv', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('joker_guide.v1.JokerEnv', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class JokerEnv(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def Reset(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/joker_guide.v1.JokerEnv/Reset',
            joker__guide__pb2.ResetRequest.SerializeToString,
            joker__guide__pb2.ResetResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
