...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ENVINFO']._serialized_end=1552
  _globals['_JOKERENV']._serialized_start=1555
  _globals['_JOKERENV']._serialized_end=1778
